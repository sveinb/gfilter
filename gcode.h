...
#define COOLANT_FLOOD_ENABLE  bit(6) // M8 (NOTE: Uses planner condition bit flag)
#define COOLANT_MIST_ENABLE   bit(7)  // M7 (NOTE: Uses planner condition bit flag)
...
uint8_t gc_parse_line(char *line, parser_block_t *block);
